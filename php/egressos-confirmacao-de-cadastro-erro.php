...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-light">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active link-secondary" href="egressos-cadastro.php">Cadastro</a>
                  </li>
                  <!-- <li class="nav-item">
    ...
    <main>
        ...
        <p>Erro!</p>
        <h2>Cadastro não pôde ser realizado.</h2>
        <div class="ok-btn">
        <a href="egressos-cadastro.php" class="btn btn-danger">OK</a>
  </div>
    </main>
</body>
