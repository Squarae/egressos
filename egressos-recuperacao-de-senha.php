...
<main>
  <form action="" method="post">
    <div>
        ...
        <input type="email" class="form-control" id="emailDeRecuperacao" name="emailDeRecuperacao" placeholder="Ex.:JoãoMartins02@gmail.com"><br>
        <button type="button" class="btn btn-primary" id="btn-recuperacaoEmail" onclick="validaRecuperacaoEmail()">Continuar</a>
    </div>
  </form>
</main>
</body>
